...
// void writeRes(Tsymbol* op1, Tsymbol* op2, Tsymbol* final){
...
// void writeProd(Tsymbol* op1, Tsymbol* op2, Tsymbol* final){
...
// void writeDiv(Tsymbol* op1, Tsymbol* op2, Tsymbol* final){
...
// void writeMod(Tsymbol* op1, Tsymbol* op2, Tsymbol* final){
...
//     char* por = "%%";
//     if(op1->type == CONSBOOL || op1->type == CONSINT)
//         sprintf(aux, "    cmpl $%s ", op1->varname);
//     else
//         sprintf(aux, "    cmpl %d(%srbp) ", op1->offset, por);
